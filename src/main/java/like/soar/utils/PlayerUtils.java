...
/*    public static double getDistanceToFall() {
    ...
    public static void tellPlayer(String string) {
        if (string != null && mc.thePlayer != null)
            mc.thePlayer.addChatMessage(new ChatComponentText(EnumChatFormatting.GRAY + "[" + EnumChatFormatting.WHITE + Soar.instance.getName() + EnumChatFormatting.GRAY + "]: " + EnumChatFormatting.GRAY + string));
    }
