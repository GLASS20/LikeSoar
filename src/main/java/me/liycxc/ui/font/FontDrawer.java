...
public final class FontDrawer {
    ...
    public void drawStringWithClientColor(String text, float x, float y, int opacity, boolean shadow) {
        ...
        for(char textChar : text.toCharArray()) {
            ...
            if (!hasReachedSS) {
                if(shadow) {
                    this.drawStringWithShadow(tmp, xTmp, y, me.liycxc.utils.color.ColorUtils.getClientColor(i, opacity).getRGB());
                }else {
                    this.drawString(tmp, xTmp, y, me.liycxc.utils.color.ColorUtils.getClientColor(i, opacity).getRGB());
                }
