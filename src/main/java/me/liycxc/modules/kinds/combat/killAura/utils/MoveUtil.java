package me.liycxc.modules.kinds.combat.killAura.utils;
...
//    public void setMoveEvent(final EventMotion moveEvent, final double moveSpeed) {
...
//    }
//
//    public void setMoveEvent(final EventMotion moveEvent, final double moveSpeed, final float pseudoYaw, final double pseudoStrafe, final double pseudoForward) {
...
//     */
//    public void fixMovement(final EventStrafe event, final float yaw) {
