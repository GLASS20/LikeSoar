package me.liycxc.modules.clickgui.impl.features;
...
import me.liycxc.modules.clickgui.comp.Comp;
import me.liycxc.modules.clickgui.comp.impl.CompBoolean;
import me.liycxc.modules.clickgui.comp.impl.CompFloat;
import me.liycxc.modules.clickgui.comp.impl.CompInt;
import me.liycxc.modules.clickgui.comp.impl.CompList;
...
public class MovementModules extends FeatureCategory {
    ...
    public void initGui() {
        ...
        for(Module m : NekoCat.instance.moduleManager.getModules()) {
            if (m.getModuleCategory()!=ModuleCategory.Movement) {
                continue;
            }
            m.selectTimer.reset();
        }
