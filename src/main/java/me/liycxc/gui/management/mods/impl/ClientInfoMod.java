...
public class ClientInfoMod extends Mod {
	...
	public void onRender2D(EventRender2D event) {
		...
		switch(mode) {
			case "Text":
				FontUtils.regular_bold36.drawStringWithClientColor("NekoCat Client", this.getX(), this.getY(), true);
				
				this.setWidth((int) FontUtils.regular_bold36.getStringWidth("NekoCat Client"));
				this.setHeight((int) FontUtils.regular_bold36.getHeight());
				break;
			case "Chill":
				String text = "NekoCat | " + Minecraft.getDebugFPS() + "fps | " + mc.thePlayer.getName();
