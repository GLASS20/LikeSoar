...
import me.liycxc.gui.management.events.impl.EventSendPacket;
...
public class VelocityMod extends Mod {
    ...
    public void onPacketReceive(EventReceivePacket event) {
        float horizontal = NekoCat.instance.settingsManager.getSettingByName(this,"Horizontal").getValInt();
        float vertical = NekoCat.instance.settingsManager.getSettingByName(this,"Vertical").getValInt();
        if (NekoCat.instance.settingsManager.getSettingByName(this,"Mode").getValString().equals("Packet")) {
    ...
    public void onUpdate(EventUpdate e) {
        if (NekoCat.instance.settingsManager.getSettingByName(this,"Mode").getValString().equals("AAC3")) {
        ...
        } else if (NekoCat.instance.settingsManager.getSettingByName(this,"Mode").getValString().equals("AAC4")) {
    ...
    public void onPacketSend(EventSendPacket event) {
        if (!NekoCat.instance.settingsManager.getSettingByName(this,"Mode").getValString().equals("AAC"))
            return;
