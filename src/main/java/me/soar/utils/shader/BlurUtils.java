...
public class BlurUtils {
    ...
    public static void drawBlurScreen() {
        ...
        (blurShader).getListShaders().get(0).getShaderManager().getShaderUniform("Radius").set((int) Soar.instance.settingsManager.getSettingByClass(MenuBlurMod.class, "Radius").getValDouble());
        (blurShader).getListShaders().get(1).getShaderManager().getShaderUniform("Radius").set((int) Soar.instance.settingsManager.getSettingByClass(MenuBlurMod.class, "Radius").getValDouble());
